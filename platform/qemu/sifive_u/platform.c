...
#define SIFIVE_U_SYS_CLK			30000000
#define SIFIVE_U_PERIPH_CLK			SIFIVE_U_SYS_CLK

#define SIFIVE_U_CLINT_ADDR			0x2000000

#define SIFIVE_U_PLIC_ADDR			0xc000000
#define SIFIVE_U_PLIC_NUM_SOURCES		0x35
#define SIFIVE_U_PLIC_NUM_PRIORITIES		4

#define SIFIVE_U_UART0_ADDR			0x60000000
#define SIFIVE_U_UART1_ADDR			0x60000000
